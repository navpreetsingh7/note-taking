...
lb1=Label(head,text='-- Notes --',height=3,width=10).grid(row=3,column=0)
...
def butt():
    b = Button(frame5, text='Update', bg='black', fg='green', command=Up).grid(row=4,column=2)

    c = Button(frame5, text='Delete', bg='blue', fg='green', command=dele).grid(row=5,column=2)

    d = Button(frame5, text='Read', bg='blue', fg='green', command=redd).grid(row=6,column=2)

    e=Button(frame5, text='Sort', bg='blue', fg='green', command=sot).grid(row=3,column=2)

button2=Button(frame1,text='List All Notes',bg='blue',width=25,height=2,fg='white',command=liste).grid(row=0,column=1,padx=5,pady=10)
button3=Button(frame2,text='Search',bg='blue',width=10,height=1,fg='white',command=search).grid(row=2,column=1)
